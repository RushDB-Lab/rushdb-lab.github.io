    ...
    <div class="achievements">
        ...
        <div class="achievement-item featured">
          ...
          <div class="achievement-content">
            <div class="achievement-title">
              {{ t("achievements.items.db2025.title") }}
            </div>
            <div class="achievement-result">
              {{ t("achievements.items.db2025.result") }}
            </div>
            <div class="achievement-desc">
              {{ t("achievements.items.db2025.desc") }}
            </div>
          </div>
        </div>
      </a>
      ...
      >
        <div class="achievement-item featured">
          ...
          <div class="achievement-content">
            <div class="achievement-title">
              {{ t("achievements.items.oceanbase2024.title") }}
            </div>
            <div class="achievement-result">
              {{ t("achievements.items.oceanbase2024.result") }}
            </div>
            <div class="achievement-desc">
              {{ t("achievements.items.oceanbase2024.desc") }}
            </div>
          </div>
        </div>
      </a>
      ...
      >
        <div class="achievement-item featured">
          ...
          <div class="achievement-content">
            <div class="achievement-title">
              {{ t("achievements.items.db2024.title") }}
            </div>
            <div class="achievement-result">
              {{ t("achievements.items.db2024.result") }}
            </div>
            <div class="achievement-desc">
              {{ t("achievements.items.db2024.desc") }}
            </div>
          </div>
        </div>
      </a>
